            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card text-black">
                        ...
                        <img src="https://static.thenounproject.com/png/1678723-200.png" width="400" height="300"alt="supposed to be item"/>
                        <div class="card-body">
                                ...
                                @foreach($supplies as $supply)
                                    <div>
                                        <span style="text-align: center; display: block;"><strong>IMEI: </strong>{{$supply->IMEI}}
                                            <a href="{{route('delete.item',['id'=>$supply->id])}}"><i class="bi bi-trash"></i></a></span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
