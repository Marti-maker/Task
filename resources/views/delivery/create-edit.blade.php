    ...
    @endif
        ...
        <table class="table table-bordered" id="dynamicAddRemove" style="width: 700px;margin-top: 20px">
            ...
            <tr>
                <td>
                    @if(isset($delivery))
                            <input type="date" name="expected_date" class="form-control" value="{{ $delivery->expected_date }}" />
                ...
                <td>
                    @if(isset($delivery))
                        <input type="text" name="warehouse" placeholder="Place warehouse name" class="form-control" value="{{$delivery->warehouse}}"/>
                    @else
                        <input type="text" name="warehouse" placeholder="Place warehouse name" class="form-control" />
                    @endif
